...
<body>
  <div class="header">
    ...
    <div class="nav">
      <a href="index">文章</a>
      <a href="whisper"  class="active">微语</a>
      <a href="leacots">留言</a>
      <a href="album">相册</a>
      <a href="about">关于</a>
    </div>
    <ul class="layui-nav header-down-nav">
      ...
      <li class="layui-nav-item"><a href="whisper"  class="active">微语</a></li>
      ...
      <div class="whisper-list">
        <div class="item-box">
          ...
          <div class="review-version layui-hide">
              ...
              <div class="list-cont">
                <div class="cont">
                  <div class="img">
                    <img src="/demo/img/header.png" alt="">
                  </div>
                  <div class="text">
        ...
        <div class="item-box">
          <div class="item">
            ...
            <div class="img-box">
              <img src="/demo/img/wy_img2.jpg">
              <img src="/demo/img/wy_img3.jpg">
              <img src="/demo/img/wy_img4.jpg">
            </div>
            <div class="op-list">
              <p class="like"><i class="layui-icon layui-icon-praise"></i><span>1200</span></p> 
              <p class="edit"><i class="layui-icon layui-icon-reply-fill"></i><span>1200</span></p>
